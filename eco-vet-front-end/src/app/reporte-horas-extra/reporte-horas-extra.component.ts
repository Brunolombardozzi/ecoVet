...
@Component({
  ...
  styleUrls: ['./reporte-horas-extra.component.css']
})
export class ReporteHorasExtraComponent {
  ...
  displayedColumns: string[] = ['nombreEcografista', 'fecha','monto','metodoPago','apellido','nombreMascota','montoHorasExtra'];
